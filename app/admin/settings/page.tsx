    ...
    <div className="p-8 max-w-xl">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
        ...
        <button onClick={changePassword} disabled={saving}
          ...
          {saving ? "Kaydediliyor..." : (
            <span className="inline-flex items-center gap-2"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>Şifreyi Değiştir</span>
          )}
        </button>
      </div>
