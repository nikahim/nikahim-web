...
export default function WatchPage() {
  ...
  const renderWelcomeChooser = (ready: boolean, onJoin: () => void, onPhoto: () => void) => {
    ...
    const bigVideo = <img src="/yayina-katil-line.webp" alt="" className="w-[clamp(73px,19vw,84px)] h-[clamp(61px,15.5vw,70px)] object-contain" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />;
    const bigImage = <img src="/foto-ekle-line.webp" alt="" className="w-[clamp(73px,19vw,84px)] h-[clamp(61px,15.5vw,70px)] object-contain" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />;
