...
export default function WatchPage() {
  ...
  const renderWelcomeActions = () => {
    ...
    const items = [
      { title: 'Tebrik Et', desc: 'Video, sesli veya yazılı mesaj bırakın.', icon: icTebrik, img: '/cy-tebrik.webp', accent: rose, tint: 'rgba(201,111,120,0.10)', tab: 'tebrik' as const },
      ...
      { title: 'Albümü Keşfet', desc: 'Fotoğrafları görün ve kendi karelerinizi paylaşın.', icon: icAlbum, img: '/cy-album.webp', accent: rose, tint: 'rgba(201,111,120,0.10)', tab: 'album' as const },
    ];
    return (
