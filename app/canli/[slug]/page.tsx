...
export default function WatchPage() {
  ...
  const renderWelcomeActions = () => {
    ...
    const items = [
      { title: 'Tebrik Et', desc: 'Video, sesli veya yazılı mesaj bırakın.', icon: icTebrik, img: '/wa-tebrik.webp', accent: rose, tint: 'rgba(201,111,120,0.10)', tab: 'tebrik' as const },
      { title: 'Altın Tak', desc: 'Çifte takmak istediğiniz altın karşılığı TL gönderin.', icon: icAltin, img: '/wa-altin.webp', accent: gold, tint: '#FAF5E8', tab: 'altin' as const },
      { title: 'Albümü Keşfet', desc: 'Fotoğrafları görün ve kendi karelerinizi paylaşın.', icon: icAlbum, img: '/wa-album.webp', accent: rose, tint: 'rgba(201,111,120,0.10)', tab: 'album' as const },
    ];
    return (
