...
// Çift Girişi butonu ikonu — CSS mask için inline data-URI (network isteği yok → anında, flash olmadan açılır)
const CIFT_ICON_MASK = "url(data:image/webp;base64,)";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden" style={{ background: '#FAF7F5' }}>
            ...
            <div className="px-5 pb-8 space-y-2.5">
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 6px 18px rgba(200,104,110,0.10), 0 1px 3px rgba(0,0,0,0.03), inset 0 1px 0 rgba(255,255,255,0.9)',
                }}>
          ...
          <div className="flex items-center justify-between h-[72px] lg:h-[80px] relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="/cift-giris"
                ...
                <span aria-hidden="true" className="inline-block flex-shrink-0" style={{ width: '22px', height: '20px', backgroundColor: 'currentColor', WebkitMaskImage: CIFT_ICON_MASK, maskImage: CIFT_ICON_MASK, WebkitMaskRepeat: 'no-repeat', maskRepeat: 'no-repeat', WebkitMaskPosition: 'center', maskPosition: 'center', WebkitMaskSize: 'contain', maskSize: 'contain' }} />
                Çift Girişi
              </a>
      ...
      <div aria-hidden="true" className="flex items-center justify-center gap-2.5 py-3 md:py-4" style={{ background: 'linear-gradient(180deg, #FAF7F5 0%, #FAF7F5 50%, #FEFDFC 50%, #FEFDFC 100%)' }}>
      ...
      <section id="ozellikler" className="py-16" style={{ background: '#FEFDFC', scrollMarginTop: '80px' }}>
        <div className="max-w-[1340px] mx-auto px-6 space-y-16 md:space-y-20">
          {/* Canlı Yayın */}
          {/* Mobil — transparan dikey kart (doğal oran), üstte içerik */}
          <div className="lg:hidden relative mx-auto w-full max-w-[420px]" style={{ aspectRatio: '1000 / 1573' }}>
            <img src="/kart-canli-t.webp" alt="Canlı Yayın ile mutluluğunuzu paylaşın" loading="lazy" decoding="async" className="absolute inset-0 w-full h-full object-contain pointer-events-none select-none" style={{ filter: 'drop-shadow(0 16px 38px rgba(72,47,42,0.10))' }} />
            <div className="absolute inset-x-0 top-0" style={{ padding: 'clamp(22px,6.2vw,30px) clamp(24px,6.5vw,32px) 0' }}>
              <div className="mb-[clamp(8px,2.6vw,12px)]"><FeatureBadge label="CANLI YAYIN" live /></div>
              <h3 className="leading-[1.04]" style={{ fontFamily: 'var(--font-playfair)', color: '#C8686E', fontWeight: 600, fontSize: 'clamp(26px,7.2vw,38px)' }}>Sevdikleriniz,</h3>
              <h3 className="leading-[1.1] mt-0.5" style={{ fontFamily: 'var(--font-playfair)', color: '#1F1F1F', fontWeight: 600, fontSize: 'clamp(19px,5.2vw,28px)' }}>o an yanınızda.</h3>
              <div className="mt-[clamp(8px,2.4vw,11px)]" style={{ width: 'clamp(44px,11vw,60px)', height: '2px', background: '#C8686E', borderRadius: '2px' }} />
              <p className="mt-[clamp(8px,2.4vw,11px)] leading-relaxed" style={{ color: '#6E5A5A', fontSize: 'clamp(12px,3.3vw,13.5px)', maxWidth: '96%' }}>Uzakta olan sevdikleriniz bu özel anı sizinle birlikte, canlı ve gerçek zamanlı olarak yaşasın.</p>
              <div className="grid grid-cols-3 gap-2 mt-[clamp(13px,3.6vw,18px)]">
                {[
                  { label: 'Full HD', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="13" rx="2" /><path strokeLinecap="round" d="M8 21h8M12 17v4" /></svg> },
                  { label: 'Tek Tıkla Yayın', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 3l7 17 2.2-6.8L20 11 4 3z" /></svg> },
                  { label: 'Uygulamasız İzleme', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><rect x="7" y="2" width="10" height="20" rx="2" /><line x1="3" y1="3" x2="21" y2="21" strokeLinecap="round" /></svg> },
                ].map((b, i) => (
          ...
          <div className="feature-card-hover hidden lg:block relative rounded-[28px] overflow-hidden mx-auto w-full lg:aspect-[2172/724] lg:max-w-none" style={{ boxShadow: '0 18px 50px rgba(72,47,42,0.055), 0 2px 8px rgba(72,47,42,0.025)', border: '1px solid rgba(174,112,108,0.13)' }}>
            ...
            <div className="hidden lg:flex absolute left-0 top-0 h-full w-[52%] flex-col justify-center pl-[176px] pr-4">
              <div className="mb-5"><FeatureBadge label="CANLI YAYIN" live /></div>
              <h3 className="leading-[1.06]" style={{ fontFamily: 'var(--font-playfair)', color: '#C8686E', fontWeight: 600, fontSize: 'clamp(26px, 2.4vw, 38px)' }}>Sevdikleriniz,</h3>
              <h3 className="leading-[1.1] mt-1" style={{ fontFamily: 'var(--font-playfair)', color: '#1F1F1F', fontWeight: 600, fontSize: 'clamp(19px, 1.8vw, 28px)' }}>o an yanınızda.</h3>
              <div className="mt-3 mb-3" style={{ width: '60px', height: '2px', background: '#C8686E', borderRadius: '2px' }} />
              <p className="leading-snug text-[13px] lg:text-[14px] mb-5 max-w-[470px]" style={{ color: '#6E5A5A' }}>Düğününüzü canlı yayınlayın. Uzakta olan sevdikleriniz<br />de bu özel anı sizinle birlikte yaşasın.</p>
              <div className="flex flex-col gap-3 items-start">
                {[
                  { label: 'Full HD', icon: <svg className="w-[17px] h-[17px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="13" rx="2" /><path strokeLinecap="round" d="M8 21h8M12 17v4" /></svg> },
                  { label: 'Tek Tıkla Yayın', icon: <svg className="w-[17px] h-[17px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 3l7 17 2.2-6.8L20 11 4 3z" /></svg> },
...
{/* Tebrik Mesajları */}
          ...
          <div className="lg:hidden relative mx-auto w-full max-w-[420px]" style={{ aspectRatio: '807 / 1349' }}>
            ...
            <div className="absolute inset-x-0 top-0" style={{ padding: 'clamp(22px,6.2vw,30px) clamp(24px,6.5vw,32px) 0' }}>
              <div className="mb-[clamp(8px,2.6vw,12px)]"><FeatureBadge label="TEBRİK MESAJLARI" sm /></div>
              <h3 className="leading-[1.04]" style={{ fontFamily: 'var(--font-playfair)', color: '#C8686E', fontWeight: 600, fontSize: 'clamp(22px,6.1vw,34px)' }}>Sevdiklerinizin mesajları,</h3>
              <h3 className="leading-[1.1] mt-0.5" style={{ fontFamily: 'var(--font-playfair)', color: '#1F1F1F', fontWeight: 600, fontSize: 'clamp(19px,5.2vw,28px)' }}>hep sizinle.</h3>
              <div className="mt-[clamp(8px,2.4vw,11px)]" style={{ width: 'clamp(44px,11vw,60px)', height: '2px', background: '#C8686E', borderRadius: '2px' }} />
              <p className="mt-[clamp(8px,2.4vw,11px)] leading-relaxed" style={{ color: '#6E5A5A', fontSize: 'clamp(12px,3.3vw,13.5px)', maxWidth: '96%' }}>Video, sesli veya yazılı… Sevdiklerinizden gelen tüm tebrikleri tek yerde saklayın.</p>
              <div className="grid grid-cols-3 gap-2 mt-[clamp(13px,3.6vw,18px)]">
                {[
                  { label: 'Video', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><rect x="2" y="6" width="13" height="12" rx="2" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5l6-3.5v10l-6-3.5z" /></svg> },
                  { label: 'Sesli', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><rect x="9" y="2" width="6" height="11" rx="3" /><path strokeLinecap="round" strokeLinejoin="round" d="M5 11a7 7 0 0014 0M12 18v3M8 21h8" /></svg> },
                  { label: 'Yazılı', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 20h9M16.5 3.5a2.12 2.12 0 013 3L7 19l-4 1 1-4 12.5-12.5z" /></svg> },
                ].map((b, i) => (
                  <div key={i} className="flex flex-col items-center text-center gap-1.5">
                    <span className="grid place-items-center rounded-[13px]" style={{ width: 'clamp(40px,11vw,48px)', height: 'clamp(40px,11vw,48px)', background: '#FFFFFF', border: '1px solid rgba(216,101,112,0.14)', boxShadow: '0 3px 10px rgba(70,45,40,0.05)', color: '#DC6873' }}>{b.icon}</span>
                    <span className="font-medium leading-tight" style={{ fontSize: 'clamp(9.5px,2.8vw,11.5px)', color: '#554F4C' }}>{b.label}</span>
          ...
          <div className="feature-card-hover hidden lg:block relative rounded-[28px] overflow-hidden mx-auto w-full lg:aspect-[3/1] lg:max-w-none" style={{ boxShadow: '0 18px 50px rgba(72,47,42,0.055), 0 2px 8px rgba(72,47,42,0.025)', border: '1px solid rgba(174,112,108,0.13)' }}>
            ...
            <div className="hidden lg:flex absolute left-0 top-0 h-full w-[52%] flex-col justify-center -translate-y-[10px] pl-[176px] pr-4">
              <div className="mb-5"><FeatureBadge label="TEBRİK MESAJLARI" /></div>
              <h3 className="leading-[1.06]" style={{ fontFamily: 'var(--font-playfair)', color: '#C8686E', fontWeight: 600, fontSize: 'clamp(24px, 2.2vw, 36px)' }}>Sevdiklerinizin mesajları,</h3>
              <h3 className="leading-[1.1] mt-1" style={{ fontFamily: 'var(--font-playfair)', color: '#1F1F1F', fontWeight: 600, fontSize: 'clamp(19px, 1.8vw, 28px)' }}>hep sizinle.</h3>
              <div className="mt-3 mb-3" style={{ width: '60px', height: '2px', background: '#C8686E', borderRadius: '2px' }} />
              <p className="leading-snug text-[13px] lg:text-[14px] max-w-[400px] mb-5" style={{ color: '#6E5A5A' }}>Video, sesli veya yazılı… Sevdiklerinizden gelen tüm tebrikleri tek yerde saklayın.</p>
              <div className="flex flex-col gap-3 items-start">
                {[
          ...
          {/* Fotoğraf Albümü — MOBİL kart (2:3 dikey) */}
          <div className="feature-card-hover lg:hidden relative rounded-[28px] overflow-hidden mx-auto w-full aspect-[2/3] max-w-[430px]" style={{ backgroundImage: 'url(/bg-album-canli.png)', backgroundSize: 'cover', backgroundPosition: 'center', boxShadow: '0 18px 50px rgba(72,47,42,0.055), 0 2px 8px rgba(72,47,42,0.025)', border: '1px solid rgba(174,112,108,0.13)' }}>
            <div className="absolute inset-0 flex flex-col" style={{ padding: 'clamp(20px,5.4vw,26px) clamp(18px,5vw,22px)' }}>
              {/* Header — badge + başlık + dash + açıklama (diğer kartlarla aynı hizalama) */}
              <div className="mb-[clamp(8px,2.6vw,12px)]"><FeatureBadge label="FOTOĞRAF ALBÜMÜ" /></div>
              ...
              <div className="relative flex-1 min-h-0 flex items-center justify-center">
                ...
                <div className="absolute" style={{ left: '50%', top: '50%', transform: 'translate(-50%, -50%)', zIndex: 3 }}>
                  <div className="bg-white p-1 rounded-xl relative album-float" style={{ boxShadow: '0 16px 36px rgba(80,60,40,0.32), 0 4px 12px rgba(0,0,0,0.10)' }}>
                    ...
                    <div className="absolute top-2.5 right-2.5 flex items-center gap-1 px-2 py-1 rounded-full" style={{ background: 'rgba(255,255,255,0.94)', boxShadow: '0 2px 7px rgba(80,60,40,0.16)' }}>
                      <svg className="w-3 h-3" fill="none" stroke="#C26068" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 9V3h12v6M6 18H5a2 2 0 01-2-2v-3a2 2 0 012-2h14a2 2 0 012 2v3a2 2 0 01-2 2h-1M6 14h12v5H6z" /></svg>
                      <span className="text-[9px] font-bold leading-none" style={{ color: '#9F4F58' }}>Baskıya Gönder</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* 3 özellik yan yana */}
              <div className="grid grid-cols-3 gap-2 mt-[clamp(10px,3vw,16px)]">
                {[
                  { label: 'Tek Albüm', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg> },
                  { label: 'Kolay Yükleme', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 15V4M8 8l4-4 4 4M4 15v3a2 2 0 002 2h12a2 2 0 002-2v-3" /></svg> },
                  { label: 'Fotoğraf Baskısı', icon: <svg className="w-[clamp(16px,4.5vw,19px)] h-[clamp(16px,4.5vw,19px)]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 9V3h12v6M6 18H5a2 2 0 01-2-2v-3a2 2 0 012-2h14a2 2 0 012 2v3a2 2 0 01-2 2h-1M6 14h12v7H6z" /></svg> },
                ].map((b, i) => (
                  <div key={i} className="flex flex-col items-center text-center gap-1.5">
                    <span className="grid place-items-center rounded-[13px]" style={{ width: 'clamp(40px,11vw,48px)', height: 'clamp(40px,11vw,48px)', background: '#FFFFFF', border: '1px solid rgba(216,101,112,0.14)', boxShadow: '0 3px 10px rgba(70,45,40,0.05)', color: '#DC6873' }}>{b.icon}</span>
                    <span className="font-medium leading-tight" style={{ fontSize: 'clamp(9.5px,2.8vw,11.5px)', color: '#554F4C' }}>{b.label}</span>
            ...
            <div className="absolute right-0 top-0 h-full w-[48%]">
              ...
              <div className="absolute" style={{ left: '50%', top: '40%', transform: 'translate(-50%, -50%)', zIndex: 3 }}>
                <div className="bg-white p-1 rounded-xl relative album-float" style={{ boxShadow: '0 16px 36px rgba(80,60,40,0.32), 0 4px 12px rgba(0,0,0,0.10)' }}>
                  ...
                  <div className="absolute top-1.5 right-1.5 flex items-center gap-1 px-2 py-1 rounded-full" style={{ background: 'rgba(255,255,255,0.94)', boxShadow: '0 2px 7px rgba(80,60,40,0.16)' }}>
                    <svg className="w-3 h-3" fill="none" stroke="#C26068" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 9V3h12v6M6 18H5a2 2 0 01-2-2v-3a2 2 0 012-2h14a2 2 0 012 2v3a2 2 0 01-2 2h-1M6 14h12v5H6z" /></svg>
                    <span className="text-[8.5px] font-bold leading-none" style={{ color: '#9F4F58' }}>Baskıya Gönder</span>
                  </div>
                </div>
              </div>

              {/* Filmstrip — sol kolonda ortalı, 15px yukarı (18→33) */}
              <div className="absolute left-1/2 -translate-x-1/2 overflow-hidden" style={{ bottom: '34px', width: '440px', maskImage: 'linear-gradient(to right, transparent 0, black 8%, black 92%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to right, transparent 0, black 8%, black 92%, transparent 100%)' }}>
                <style>{`
                  ...
                  @media (prefers-reduced-motion: reduce) {
                    .album-float { animation: none !important; }
                  }
                `}</style>
            ...
            <div className="absolute left-0 top-0 h-full w-[52%] flex flex-col justify-center pl-[176px] pr-4">
              ...
              <div className="flex flex-row gap-5 items-center flex-wrap">
                {[
                  ...
                  { label: 'Kolay Yükleme', icon: <svg className="w-[17px] h-[17px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 15V4M8 8l4-4 4 4M4 15v3a2 2 0 002 2h12a2 2 0 002-2v-3" /></svg> },
                  { label: 'Fotoğraf Baskısı', icon: <svg className="w-[17px] h-[17px]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M6 9V3h12v6M6 18H5a2 2 0 01-2-2v-3a2 2 0 012-2h14a2 2 0 012 2v3a2 2 0 01-2 2h-1M6 14h12v7H6z" /></svg> },
                ].map((b, i) => (
                  <div key={i} className="flex items-center gap-2.5">
                    <span className="w-[38px] h-[38px] flex-shrink-0 grid place-items-center rounded-[12px]" style={{ background: 'rgba(255,255,255,0.88)', border: '1px solid rgba(216,101,112,0.12)', boxShadow: '0 4px 14px rgba(70,45,40,0.04)', color: '#DC6873' }}>{b.icon}</span>
                    <span className="text-[13px] font-medium whitespace-nowrap" style={{ color: '#554F4C' }}>{b.label}</span>
      ...
      <div aria-hidden="true" className="flex items-center justify-center gap-2.5 py-3 md:py-4" style={{ background: 'linear-gradient(180deg, #FEFDFC 0%, #FEFDFC 50%, #FDF7F3 50%, #FDF7F3 100%)' }}>
        <span className="h-px w-14 md:w-20" style={{ background: 'linear-gradient(90deg, transparent, rgba(200,104,110,0.30), transparent)' }} />
        <span className="w-1 h-1 rounded-full" style={{ background: 'rgba(200,104,110,0.45)' }} />
        <span className="h-px w-14 md:w-20" style={{ background: 'linear-gradient(90deg, transparent, rgba(200,104,110,0.30), transparent)' }} />
      </div>
      ...
      <section id="neden-nikahim" className="py-16 md:py-14 relative overflow-hidden" style={{ background: '#FAF7F5', scrollMarginTop: '80px' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          <div className="text-center mb-10 md:mb-12">
            ...
            <p className="text-lg text-gray-400 max-w-xl mx-auto">Bu özel gün için ihtiyacınız olan her şey tek platformda!</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-7">
            {[
              { title: 'Canlı Yayın', desc: 'Düğününüz için size özel bir yayın sayfası oluşturulur. Davetliler bağlantıya dokunarak uygulama veya üyelik gerektirmeden yayını izleyebilir. Yayın kaydınız daha sonra tekrar izlenebilir.', badges: ['Özel Yayın Sayfası', 'Uygulamasız Katılım', 'Yayın Kaydı'], icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg> },
              { title: 'Akıllı Masa Planlayıcısı', desc: 'Davetli listenizi oluşturun, kimlerin katılacağını tek yerden takip edin. Akıllı planlayıcı, gelen davetlileriniz için en uygun masa düzenini oluştursun.', badges: ['Davetli Takibi', 'Akıllı Yerleşim', 'Sürükle & Düzenle'], dualIcon: true, icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1.5" strokeWidth={1.8} /><rect x="14" y="3" width="7" height="7" rx="1.5" strokeWidth={1.8} /><rect x="3" y="14" width="7" height="7" rx="1.5" strokeWidth={1.8} /><rect x="14" y="14" width="7" height="7" rx="1.5" strokeWidth={1.8} /></svg>, icon2: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a3 3 0 00-4.681 2.72 8.986 8.986 0 003.74.477m.94-3.197a5.971 5.971 0 00-.94 3.197M15 6.75a3 3 0 11-6 0 3 3 0 016 0zm6 3a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-13.5 0a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z" /></svg> },
              { title: 'Tebrik Mesajları', desc: 'Davetlileriniz size video, sesli veya yazılı tebrik bırakabilir. Gelen tüm mesajları uygulama üzerinden tek yerde görüntüleyebilirsiniz.', badges: ['Video', 'Sesli', 'Yazılı'], dualIcon: true, icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>, icon2: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>, icon3: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 20h9M16.5 3.5a2.12 2.12 0 013 3L7 19l-4 1 1-4 12.5-12.5z" /></svg> },
              { title: 'Altın Takma', desc: 'Davetliniz takmak istediği altını seçer ve güncel TL karşılığını doğrudan sizin hesabınıza gönderir. Nikahım paraya aracılık etmez ve gönderimden komisyon almaz.', badges: ['Doğrudan Hesabınıza', 'Aracısız', 'Komisyonsuz'], icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 10h16M5 10L12 4l7 6M6 10v8M10 10v8M14 10v8M18 10v8M4 21h16" /></svg> },
              { title: 'Fotoğraf Albümü', desc: 'Siz ve davetlileriniz telefondaki fotoğrafları aynı düğün albümüne yükleyebilirsiniz. Paylaşılan kareler çift onayından sonra albümde görüntülenir.', badges: ['Davetli Yükleme', 'Tek Albüm', 'Çift Onayı'], icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg> },
              { title: 'Fotoğraf Baskısı', desc: 'Davetlileriniz kendi fotoğraflarının, siz ise albümde beğendiğiniz tüm karelerin baskısını isteyebilirsiniz. Talepler doğrudan fotoğrafçı paneline düşer.', badges: ['Albümden Seçim', 'Baskı Talebi', 'Fotoğrafçı Paneli'], icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M6 9V3h12v6M6 18H5a2 2 0 01-2-2v-3a2 2 0 012-2h14a2 2 0 012 2v3a2 2 0 01-2 2h-1M6 14h12v7H6z" /></svg> },
            ].map((feature, i) => (
              <div key={i}
                ...
                <div className="flex gap-2 mb-5">
                  ...
                  {(feature as any).icon3 && (
                    <div className="relative w-12 h-12 rounded-2xl flex items-center justify-center transition-transform duration-300 group-hover:scale-110" style={{ background: 'rgba(200,104,110,0.08)', color: '#C8686E' }}>
                      <div aria-hidden="true" className="absolute inset-0 rounded-2xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: 'radial-gradient(circle at 50% 30%, rgba(200,104,110,0.18) 0%, transparent 70%)' }} />
                      <div className="relative">{(feature as any).icon3}</div>
                    </div>
                  )}
                </div>
      ...
      <section id="paketler" className="py-16 md:py-14" style={{ background: 'linear-gradient(180deg, #FDF7F3 0%, #FAF4F0 100%)', scrollMarginTop: '80px' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-14 md:gap-8 max-w-5xl mx-auto items-stretch">
            {[
              { id: 0, name: 'Nikah', sub: 'Temel ihtiyaçlar için ideal', price: '₺1.490', oldPrice: null, discountLabel: null, badge: null, features: ['30 Dakika Canlı Yayın', '100 İzleyici', '1080p Full HD*', 'Fotoğraf Albümü', 'Davetiye Tasarımı', 'Tebrik Mesajları', 'Yayın Kaydı ve İndirme'], disabled: [] },
              { id: 1, name: 'Düğün', sub: 'En çok tercih edilen', price: '₺2.990', oldPrice: null, discountLabel: null, badge: 'En Popüler', features: ['90 Dakika Canlı Yayın', '200 İzleyici', '1080p Full HD*', 'Masa Planlayıcısı', 'Fotoğrafçı Paneli', 'Fotoğraf Albümü', 'Davetiye Tasarımı', 'Tebrik Mesajları', 'Yayın Kaydı ve İndirme'], disabled: [] },
              { id: 2, name: 'Şölen', sub: 'Maksimum deneyim', price: '₺9.990', oldPrice: null, discountLabel: null, badge: null, features: ['180 Dakika Canlı Yayın', '300 İzleyici', '1080p Full HD*', 'Masa Planlayıcısı', 'Fotoğrafçı Paneli', 'Fotoğraf Albümü', 'Davetiye Tasarımı', 'Tebrik Mesajları', 'Yayın Kaydı ve İndirme'], disabled: [] },
            ].map((pkg) => {
              const isSelected = selectedPackage === pkg.id;
              return (
                <div key={pkg.id} onClick={() => setSelectedPackage(pkg.id)} className={`feature-card-hover relative rounded-3xl p-9 transition-all duration-500 cursor-pointer flex flex-col h-full ${isSelected ? 'scale-[1.04]' : 'hover:-translate-y-2'}`} style={isSelected ? { background: 'linear-gradient(180deg, rgba(255,255,255,0.98) 0%, rgba(253,245,243,0.96) 100%)', backdropFilter: 'blur(24px)', boxShadow: '0 30px 80px rgba(200,104,110,0.22), 0 12px 32px rgba(200,104,110,0.10), 0 2px 8px rgba(0,0,0,0.05), inset 0 1px 0 rgba(255,255,255,0.95)', border: '1.5px solid rgba(200,104,110,0.45)' } : { background: 'linear-gradient(180deg, rgba(255,255,255,0.96) 0%, rgba(252,250,248,0.94) 100%)', backdropFilter: 'blur(20px)', boxShadow: '0 16px 50px rgba(60,40,40,0.10), 0 4px 14px rgba(0,0,0,0.04), inset 0 1px 0 rgba(255,255,255,0.9)', border: '1px solid rgba(200,104,110,0.10)' }}>
                  ...
                  <ul className="space-y-4 mb-9 flex-1">
                    {pkg.features.map((f, i) => (<li key={i} className={`flex items-center gap-3 text-sm ${i < 3 || f === 'Masa Planlayıcısı' || f === 'Fotoğrafçı Paneli' ? 'font-bold text-gray-900' : 'text-gray-600'}`}><div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: `rgba(200,104,110,${isSelected ? '0.15' : '0.1'})` }}><svg className="w-3 h-3" style={{ color: '#C8686E' }} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg></div>{f}</li>))}
