    ...
    <main className="min-h-screen overflow-x-hidden" style={{ background: '#FAF7F5' }}>
      ...
      <section id="ozellikler" className="py-16" style={{ background: '#FEFDFC', scrollMarginTop: '80px' }}>
        <div className="max-w-[1340px] mx-auto px-6 space-y-16 md:space-y-20">
          ...
          <div className="lg:hidden relative mx-auto w-full max-w-[420px]" style={{ aspectRatio: '960 / 1518' }}>
          ...
          <div className="feature-card-hover relative rounded-[28px] overflow-hidden mx-auto w-full aspect-[852/1690] lg:aspect-[3/1] max-w-[440px] lg:max-w-none" style={{ boxShadow: '0 18px 50px rgba(72,47,42,0.055), 0 2px 8px rgba(72,47,42,0.025)', border: '1px solid rgba(174,112,108,0.13)' }}>
            ...
            <div className="lg:hidden absolute" style={{ top: '4.5%', left: '6%', right: '6%' }}>
              ...
              <div className="flex flex-row justify-between gap-1 mt-[clamp(9px,3.4vw,20px)]" style={{ marginRight: 'clamp(20px,9vw,44px)' }}>
                {[
                  ...
                  <div key={i} className="flex flex-col items-center text-center gap-1.5 flex-1">
                    ...
                    <span className="text-[clamp(8.6px,3vw,12.5px)] font-medium leading-tight" style={{ color: '#554F4C' }}>{b.label}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-7">
            {[
              ...
              { title: 'Akıllı Masa Planlayıcısı', desc: 'Davetli listenizi oluşturun, yakınlık ve grup tercihlerini belirleyin. Akıllı planlayıcı uygun masa dağılımını hazırlasın; istediğiniz kişileri sürükleyerek son düzenlemeleri siz yapın.', badges: ['Akıllı Yerleşim', 'Grup Tercihleri', 'Sürükle & Düzenle'], icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1.5" strokeWidth={1.8} /><rect x="14" y="3" width="7" height="7" rx="1.5" strokeWidth={1.8} /><rect x="3" y="14" width="7" height="7" rx="1.5" strokeWidth={1.8} /><rect x="14" y="14" width="7" height="7" rx="1.5" strokeWidth={1.8} /></svg> },
            ].map((feature, i) => (
              <div key={i}
