          ...
          <div
            ...
            <div className="px-7 pt-6 pb-6" style={{ borderBottom: '1px solid rgba(232,180,170,0.18)' }}>
              ...
              <p className="mt-2 text-[12.5px] flex items-center gap-1.5" style={{ color: '#6E5A5A' }}>
                ...
                Aşağıdan iletişim kanalını seçin
              </p>
            </div>
            ...
            <div className="px-5 pb-8 space-y-2.5">
              ...
              <a
                href="https://wa.me/905366919361?text=Merhaba%20%F0%9F%91%8B%20nikah%C4%B1m%20hakk%C4%B1nda%20sorular%C4%B1m%20mevcut."
                target="_blank"
        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-sm border border-gray-100">
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 flex flex-wrap justify-center gap-8">
              ...
              <a href="https://wa.me/905366919361?text=Merhaba%20%F0%9F%91%8B%20nikah%C4%B1m%20hakk%C4%B1nda%20sorular%C4%B1m%20mevcut." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm font-medium transition-colors hover:opacity-70" style={{ color: '#1E8E3E' }}>
