        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-7">
            {[
              ...
              { title: 'Fotoğraf Baskısı', desc: 'Albümdeki istediğiniz fotoğrafları baskı için seçebilirsiniz. Baskı talepleri doğrudan fotoğrafçı paneline düşer ve süreç buradan takip edilir.', badges: ['Albümden Seçim', 'Baskı Talebi', 'Fotoğrafçı Paneli'], icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M6 9V3h12v6M6 18H5a2 2 0 01-2-2v-3a2 2 0 012-2h14a2 2 0 012 2v3a2 2 0 01-2 2h-1M6 14h12v7H6z" /></svg> },
            ].map((feature, i) => (
              <div key={i}
