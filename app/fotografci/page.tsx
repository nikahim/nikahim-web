              ...
              {loading ? (
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-16">
                  <div className="w-44 h-44 mb-4 rounded-full flex items-center justify-center" style={{ background: 'radial-gradient(circle, rgba(200,104,110,0.12) 0%, transparent 70%)' }}>
                    <img src="/foto-ekle-8.webp" alt="" className="w-32 h-32 object-contain opacity-90" onError={(e) => { const el = e.currentTarget as HTMLImageElement; el.style.display = 'none'; const sib = el.nextElementSibling as HTMLElement | null; if (sib) sib.style.display = 'block'; }} />
        ...
        <div className="fixed inset-0 z-[80]" onClick={() => setShowSupport(false)}>
          ...
          <div className="absolute top-0 right-0 h-full w-full sm:max-w-[400px] flex flex-col" style={{ background: '#FFFCFA', boxShadow: '-20px 0 60px rgba(0,0,0,0.18)' }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-7 pt-6 pb-6 flex-shrink-0 relative" style={{ borderBottom: '1px solid rgba(232,180,170,0.18)' }}>
              ...
              <h2 className="font-bold text-[24px] lg:text-[29px] leading-[1.15]" style={{ fontFamily: 'var(--font-playfair)', color: '#1F1F1F' }}>Destek</h2>
