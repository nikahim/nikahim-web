...
export const fullFaqCategories: FaqCategory[] = [
  {
    ...
    items: [
      ...
      { q: 'Yayın kaydı ne kadar süre saklanır?', a: 'Canlı yayın kayıtları Nikahım platformunda 30 gün boyunca saklanır. Bu süre esnasında çiftler uygulama üzerinden kayıtlarını indirebilirler.',
        keywords: ['canlı yayın kaydı', 'düğün videosu', 'nikah videosu', 'yayın arşivi', 'video saklama', 'kayıtlı yayın', 'yayın geçmişi', 'video indirme', 'düğün kaydı', 'nikah kaydı', '30 gün'] },
      ...
      { q: 'Yayını sonradan tekrar izleyebilir miyim?', a: 'Yayın kaydını 30 gün süresince uygulama içerisindeki Düğünüm/Nikahım bölümünden izleyebilirsiniz.',
      ...
      { q: 'İzleyici sayısı limiti var mı?', a: 'İzleyici sayısı limiti paketinize göre değişmektedir. Nikah paketinde 100, Düğün paketinde 200 ve Şölen paketinde 300 davetli yayınızı izleyebilir.',
  ...
  },
  {
    ...
    items: [
      { q: 'Hangi paketler var?', a: 'Nikahım çiftlere 3 farklı seviyede paket sunmaktadır. Bunlar Nikah, Düğün ve Şölen paketleridir.',
        keywords: ['nikah paketi', 'düğün paketi', 'şölen paketi', 'yayın paketi', 'canlı yayın hizmeti', 'paket seçenekleri', 'uygulama paketi', 'paket karşılaştırma'] },
      { q: 'Paketler arası fark nedir?', a: 'Paketler arası farklara nikahim.com ana sayfasından ulaşabilirsiniz.',
        keywords: ['paket farkı', 'özellik karşılaştırma', 'düğün avantajları', 'şölen avantajları', 'paket özellikleri', 'yayın özellikleri', 'izleyici limiti', 'yayın süresi', 'paket seçimi', 'hizmet farkları'] },
      ...
      { q: 'Paketimi yükseltebilir miyim?', a: 'Evet, eğer davetli sayınızın artacağını veya daha fazla süreye ihtiyaç duyduğunuzu düşünüyorsanız bir üst pakete geçebilir yada ek paketlerden satın alabilirsiniz.',
        keywords: ['paket yükseltme', 'üst pakete geçiş', 'düğün yükseltme', 'şölen yükseltme', 'ek özellik', 'paket değiştirme', 'daha fazla davetli', 'daha fazla süre', 'yükseltme işlemi', 'paket güncelleme', 'upgrade'] },
